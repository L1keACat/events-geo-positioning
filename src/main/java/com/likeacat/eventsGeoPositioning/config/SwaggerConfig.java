...
import com.likeacat.eventsGeoPositioning.model.*;
...
public class SwaggerConfig {
    ...
    public Docket api() {
        return new Docket(DocumentationType.SWAGGER_2)
                .select()
                .apis(RequestHandlerSelectors.basePackage("com.likeacat.eventsGeoPositioning"))
    ...
    private ApiInfo apiInfo() {
        return new ApiInfoBuilder().title("Events Geo Positioning")
                ...
                .contact(new Contact("Adam Abdullaev", "https://vk.com/l1keacat", "abdul.adam16@mail.ru"))
                .version("1.1.2")
                .build();
    }
}
